...
public class ClientUI extends JFrame implements ActionListener {	
	...
	public ClientUI() {
		...
		lblChatClient = new JLabel("Chat kliens");
		...
		lblName = new JLabel("Felhasznalonev");
		...
		btnStart = new JButton("Csatlakozas");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnStart) {
			if(btnStart.getText().equals("Csatlakozas")) {
				btnStart.setText("Kilepes");
				start();
			}else {
				btnStart.setText("Csatlakozas");
				stop();
			}
